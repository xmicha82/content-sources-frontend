...
it('Render enabled with snapshots enabled', async () => {
...
it('Render disabled with snapshots enabled', async () => {
  (useAppContext as jest.Mock).mockImplementation(() => ({
    features: {
      snapshots: {
        enabled: true,
...
it('Render enabled with snapshots disabled', async () => {
  (useAppContext as jest.Mock).mockImplementation(() => ({
    features: {
      snapshots: {
        enabled: false,
...
it('Render disabled with snapshots disabld', async () => {
  (useAppContext as jest.Mock).mockImplementation(() => ({
    features: {
      snapshots: {
        enabled: false,
